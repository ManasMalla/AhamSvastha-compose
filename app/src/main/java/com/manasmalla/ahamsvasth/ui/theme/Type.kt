package com.manasmalla.ahamsvasth.ui.theme
...
val GoogleSansFontFamily = FontFamily(
    fonts = listOf(
        ...
        Font(R.font.google_sans_bold_italic, weight = FontWeight.Bold, style = FontStyle.Italic),
        Font(R.font.google_sans_medium, weight = FontWeight.Medium),
        Font(
            R.font.google_sans_medium_italic, weight = FontWeight.Medium, style = FontStyle.Italic
        ),
    )
)
